...
public class LambdaTestForChromeBrowser {
	...
	public void setup() throws MalformedURLException {
		...
		browserOptions.setBrowserVersion("133.0");
		...
		ltOptions.put("build", "Lambda_Java_TestNG");
		...
		try {
			...
			driver = new RemoteWebDriver(new URL("http://" + username + ":" + accesskey + "@hub.lambdatest.com/wd/hub"),
					browserOptions);
